...
public class LoginActivity extends BaseActivity<LoginPresenter> implements LoginContract.View {
    ...
    public void onClick() {
        mPresenter.loginThird(etAccount.getText().toString(), etPwd.getText().toString(), etCommunityId.getText().toString());
    }
    @OnClick(R.id.btn_test)
    public void onClickTest(){
        mPresenter.onTestLogin();
    }
}
