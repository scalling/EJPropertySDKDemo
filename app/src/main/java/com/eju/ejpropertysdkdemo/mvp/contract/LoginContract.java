package com.eju.ejpropertysdkdemo.mvp.contract;
...
public interface LoginContract {
    ...
    interface Model extends IModel {
        Observable<BaseResp<LoginBean>> login(String loginPhone, String password);
        Observable<LoginThirdBean> loginThird(String loginPhone, String password);
    }
}
